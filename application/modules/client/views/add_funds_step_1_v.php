...
<div class='card-wrapper' style="padding:10px;"></div>
...
<div class="container wow fadeIn" data-wow-duration="2s">
    ...
    <div style="background: #475d62">
        <form class="text-center border border-light p-5" action="https://secure.bluepay.com/interfaces/bp10emu" method="post">
            ...
            <p class="h4 text-info">Fund your account</p>
            ...
            <div class="form-row mb-4">
                <div class="col-6">
                    ...
                    <input name="firstname" type="text" class="form-control" placeholder="<?php echo $session_data['user_firstname']; ?>" disabled>
                </div>
                <div class="col-6">
                    <label for="lastname" class="text-warning">Last Name</label>
                    <input name="lastname" type="text"class="form-control" placeholder="<?php echo $session_data['user_lastname']; ?>" disabled>
                </div>
            </div>
            <div class="form-row mb-4">
                <div class="col">
